...
struct JNINativeInterface_ {
	...
	void (PJNICALL ReleaseStringCritical)(JNIEnv *env, jstring string, const jchar *carray);
...
struct JNIInvokeInterface_ {
	...
	jint (PJNICALL AttachCurrentThreadAsDaemon)(JavaVM *vm, void **penv, void *args);
	jint (PJNICALL QueryGCStatus)(JavaVM *vm, jint *nheaps, GCStatus *status, jint statusSize);
};
struct JavaVM_ {
    ...
    jint QueryGCStatus(jint *nheaps, GCStatus *status, jint statusSize){ return functions->QueryGCStatus(this, nheaps, status, statusSize); } 
#endif
};
